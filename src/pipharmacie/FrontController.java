...
public class FrontController implements Initializable {
  ...
  Stage stage = new Stage();
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Front/Pharmacie/pharmacie.fxml"));
...
stage1.close();
    ...
    private void versMedicament(ActionEvent event) throws IOException {
      Stage stage = new Stage();
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Front/Medicament/medicament.fxml"));
