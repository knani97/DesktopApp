...
public class InventaireService implements Initializable<Inventaire>{
    ...
    public boolean add(Inventaire i, Pharmacie ph) {
        ...
        try {
            ...
            if (ImageIO.write(bufferedImage, "png", new File("C:\\Users\\mouhe\\OneDrive\\Bureau\\images\\" + code + ".png"))) {
...
return true ;
    ...
    public Inventaire find(int med) {
        return read().stream().filter(i -> i.getMedicaments_id() == med).collect(Collectors.toList()).get(0);
    }
